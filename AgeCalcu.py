...
photo = PhotoImage(file="Age2.png")
...
Label(text="Birth Year", font=23).place(x=200, y=300)
Label(text="Birth Month", font=23).place(x=200, y=350)
Label(text="Birth Day", font=23).place(x=200, y=400)
...
image_icon = PhotoImage(file="Boy.png")
